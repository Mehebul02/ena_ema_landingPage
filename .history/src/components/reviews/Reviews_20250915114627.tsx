...
export function Revi() {
  ...
  useEffect(() => {
    ...
    }, 3500) // Slightly faster auto-advance
  ...
  return (
    <section
      className="w-full bg-slate-900 py-16 px-4 rounded-2xl"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="hidden lg:grid lg:grid-cols-4 gap-6 mb-8">
          {testimonials.map((testimonial) => (
            <Card
              key={testimonial.id}
              className="bg-slate-800 border-slate-700 p-6 hover:bg-slate-750 transition-colors"
            >
              {/* Stars */}
              ...
              {/* Content */}
              <blockquote className="text-slate-200 text-sm leading-relaxed mb-6">"{testimonial.content}"</blockquote>
            ...
            >
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="w-full flex-shrink-0 px-2">
                  <Card className="bg-slate-800 border-slate-700 p-6 mx-auto max-w-md hover:bg-slate-750 transition-colors">
                    {/* Stars */}
                    <div className="flex gap-1 mb-4">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star key={i} className="w-4 h-4 fill-green-500 text-green-500" />
                    ...
                    {/* Content */}
                    <blockquote className="text-slate-200 text-sm leading-relaxed mb-6">
                      "{testimonial.content}"
                    </blockquote>
