  ...
  return (
    <section className="bg-[#151E1B] py-8 px-4 font-manrope" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <CustomTitle className="mb-" title="What Our Clients Are Saying" middleText="About Us" description="Real feedback from real businesses who've seen real results." />
