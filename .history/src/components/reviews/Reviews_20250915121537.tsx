  ...
  return (
    <section className="bg-[#151E1B] py-8 px-4 font-manrope" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      <div className="max-w-7xl mx-auto">
        ...
        <CustomTitle title="What Our Clients Are Saying" middleText="About" lastTest="Us" description="Don't just take our word for it. Here's what real customers have to say about their experience."/>
