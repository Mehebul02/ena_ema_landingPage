        ...
        >
          {processSteps.map((step, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="text-center group cursor-pointer bg-[#192420] backdrop-blur-sm rounded-2xl p-8 border-slate-700/50 hover:border-emerald-500/30 transition-all duration-300"
            >
