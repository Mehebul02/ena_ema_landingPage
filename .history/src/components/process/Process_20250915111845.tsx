...
export function ProcessSection() {
  return (
    <section className="bg-gradient-to-b from-slate-900 to-emerald-900 py-24 px-4">
        ...
        >
          {processSteps.map((step, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="text-center group cursor-pointer bg-[#192420] backdrop-blur-sm rounded-2xl p-8 border-slate-700/50 hover:border-emerald-500/30 transition-all duration-300 p-8"
            >
