...
const RealCustomer = () => {
    return (
       ...
       <div className='flex flex-col text-white py-12 font-manrope p-4 ', className)}>
            <h1 className={twMerge(' text-3xl md:text-5xl font-medium  mb-4 mt-8',titleClass)}>{title} <span className='text-[#1FFFA5]'>{middleText}</span> {lastTest}</h1>
