      ...
      <Container>
        <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            {/* Form */}
            <div className="max-w-2xl mx-auto border border-["use client"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-[#0f2f22] border border-[#2a5a47] text-white placeholder:text-gray-400 h-12 w-full px-3 rounded-md"
                    />
                    {errors.name && (
...
] rounded-md shadow-2xl shadow-amber-200">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <Label.Root htmlFor="name" className="sr-only">
