...
export default function BannerSection() {
  ...
  return (
    <div className="relative min-h-[1289px] w-full bg-[#151E1B] text-white font-manrope flex items-center justify-center p-2 overflow-hidden">
     <Container  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[816px] h-[252px] bg-[#1FFFA5] opacity-20 blur-[351px] rounded-full">
     ...
     <TrustBadge/>
      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="max-w-2xl mx-auto border border-[#151E1B] rounded-md shadow-2xl shadow-amber-200">
