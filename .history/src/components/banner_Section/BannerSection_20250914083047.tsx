...
export default function BannerSection() {
  ...
  return (
    <div className="min-h-[1289px] bg-gradient-to-b bg-[linear-gradient(135deg,#0b2d1a_0%,#05110b_100%)] text-white font-manrope p-2">
     <Container>

         {/* Header */}
      <header className="flex justify-center pt-12 pb-32">
