                        ...
                        >
                            {caseStudies.map((study) => (
                                <div key={study.id} className="w-1/2 flex-shrink-0 px-4">
                                    <div className="bg-[#192420] backdrop-blur-sm border border-slate-700/50 hover:border-emerald-500/30 transition-all duration-300 h-full min-h-[280px] p-8 rou">
                                        {/* Laptop Mockup */}
