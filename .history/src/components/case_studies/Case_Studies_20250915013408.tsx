            ...
            <div className="max-w-7xl mx-auto relative">
                ...
                <div className="relative mb-16">
                    ...
                    <div className="overflow-hidden">
                        <div
                            className="rounded-lg bg-[#192420] backdrop-blur-sm border border-slate-700/50 hover:border-emerald-500/30 transition-all duration-300 h-full min-h-[280px] flex flex-col"
