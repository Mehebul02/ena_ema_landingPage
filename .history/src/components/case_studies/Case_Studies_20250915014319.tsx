            ...
            <div className="max-w-7xl mx-auto relative">
                ...
                <div className="relative mb-16">
                    ...
                    <div className="overflow-hidden">
                        ...
                        >
                            {caseStudies.map((study,index) => <Card key={index} study={study}/>)}
                        </div>
                    </div>
                ...
                <div className="text-center">
                    <button className="button w-full cursor-pointer bg-[#00ff88] hover:bg-[#00e67a] text-black font-semibold h-14 text-lg rounded-lg">
