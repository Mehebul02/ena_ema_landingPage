...
export default function PricingSection() {
  return (
    <div className=" bg-[#0A0F0D] py-20 px-4 font-manrope">
        <CustomTitle className="flex justify-start" title="Simple, Transparent Pricing — "  middleText="Choose Your Plan"  description="No hidden fees, no surprises. Just premium landing pages at unbeatable prices."/>
