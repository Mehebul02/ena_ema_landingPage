...
export default function PricingSection() {
  return (
    <div className=" bg-slate-900 py-20 px-4 font-manrope">
        <CustomTitle cl title="Simple, Transparent Pricing — "  middleText="Choose Your Plan"  description="No hidden fees, no surprises. Just premium landing pages at unbeatable prices."/>
