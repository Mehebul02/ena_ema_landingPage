...
const Benefits = () => {
  return (
    <div className="bg-[#151E1B] font-manrope">
      ...
      />
      <section className="py-24 px-6 bg-[#192420]">
        <div className="max-w-6xl mx-auto">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className="p-8 rounded-lg bg-slate-800/0 backdrop-blur-sm border border-slate-700/50 hover:border-emerald-500/30 transition-all duration-300 h-full min-h-[280px] flex flex-col">
