        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className="p-8 rounded-lg bg-[] backdrop-blur-sm border border-slate-700/50 hover:border-emerald-500/30 transition-all duration-300 h-full min-h-[280px] flex flex-col">
