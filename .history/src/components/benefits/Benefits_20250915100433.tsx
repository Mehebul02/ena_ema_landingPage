...
const Benefits = () => {
  return (
    <div className="bg-[#151E1B] font-manrope">
      <CustomTitle className="flex justify-center w-full mx-auto"
      ...
      <section className="py-14 px-6 ">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <Card key={index} feature={feature} index={index} itemVariants={itemVariants} iconVariants={iconVariants}/>
            )}
          </motion.div>
        </div>
      </section>
