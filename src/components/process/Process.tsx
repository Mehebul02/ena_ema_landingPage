    ...
    return (
        <section className="bg-[#151E1B] py-8 px-4 font-manrope">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    {processSteps.map((step, index) => <ProcessCard key={index} step={step} index={index} itemVariants={itemVariants} iconVariants={iconVariants} dayBadgeVariants={dayBadgeVariants} />)}
                </motion.div>
